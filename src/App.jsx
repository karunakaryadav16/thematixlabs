...
const App = () => {
  ...
  <div className="space-x-4">
    <button className="bg-gray-700 text-white px-4 py-2 rounded hover:bg-gray-600">Whitepaper</button>
    <button className="bg-gradient-to-r from-pink-500 to-purple-600 px-4 py-2 rounded text-white hover:opacity-90">Get Started</button>
  </div>
</header>
      ...
      <div className="flex flex-col lg:flex-row justify-between gap-x-2 lg:items-center z-0 p-6">
        ...
        <div className="w-full lg:w-1/2 h-auto lg:relative">
          ...
          >
            <img src="https://res.cloudinary.com/djexsyuur/image/upload/v1728905187/Picture_9_ygibxx.png" className="rounded-lg" alt="Image 1" />
            <img src="https://res.cloudinary.com/djexsyuur/image/upload/v1728905187/Picture_8_egozxw.png" className="rounded-lg" data-aos="fade-up" alt="Image 2" />
            <img src="https://res.cloudinary.com/djexsyuur/image/upload/v1728905189/Picture_2_eusquy.png" className="rounded-lg" alt="Image 8" />
